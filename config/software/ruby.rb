  ...
  when "aix"
    {
      ...
      "CXX" => "xlC -q64",
      "LD" => "ld -b64",
      "CFLAGS" => "-q64 -O3 -qhot -I#{install_dir}/embedded/include",
      "CXXFLAGS" => "-q64 -O3 -qhot -I#{install_dir}/embedded/include",
      "LDFLAGS" => "-q64 -O3 -qhot -L#{install_dir}/embedded/lib -Wl,-brtl -Wl,-blibpath:#{install_dir}/embedded/lib:/usr/lib:/lib",
      "OBJECT_MODE" => "64",
      "ARFLAGS" => "-X64 cru",
