...
if windows_arch_i386?
  ...
  version "3.0.3-1" do
    ...
    internal_source url: "http://localhost:8081/artifactory/generic-local/#{name}/rubyinstaller-devkit-#{version}-x86.exe"
  end
else
  version "3.0.3-1" do
    ...
    internal_source url: "http://localhost:8081/artifactory/generic-local/#{name}/rubyinstaller-devkit-#{version}-x64.exe"
  end
