...
if windows_arch_i386?
  ...
  version "3.0.3-1" do
    ...
    internal_source url: "https://0049-99-211-134-163.ngrok.io/artifactory/generic-local/#{name}/rubyinstaller-devkit-#{version}-x86.exe"
  end
else
  version "3.0.3-1" do
    ...
    internal_source url: "https://0049-99-211-134-163.ngrok.io/artifactory/generic-local/#{name}/rubyinstaller-devkit-#{version}-x64.exe"
  end
