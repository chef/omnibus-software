...
# Installs ruby from source on all platforms.
# This assumes that you have a native toolchain already available on the build.
# This could be done using build-essentials and dropping a compiler on the
# system path or by manually vendoring a compiler as part of the omnibus
# build.
...
# Maintain this flag as long as we still need the option to compile ruby for
# chef versions that shipped without FIPS.
