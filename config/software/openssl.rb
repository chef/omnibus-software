...
lib_dirs lib_dirs.push("#{install_dir}/embedded/lib/engines")
lib_dirs lib_dirs.push("#{install_dir}/embedded/lib/engines-1.1") if version.start_with?("1.1")
if version.start_with?("3.")
  lib_dirs lib_dirs.push("#{install_dir}/embedded/lib/engines-3")
  lib_dirs lib_dirs.push("#{install_dir}/embedded/lib/ossl-modules")
end
