...
#  arch = "armv6l"
  ...
  source url: "https://artifactory-internal.ps.chef.co/ui/repos/tree/General/omnibus-software-local/#{name}/#{name}-#{version}.linux-armv6l.tar.gz"
  ...
  source url: "https://artifactory-internal.ps.chef.co/ui/repos/tree/General/omnibus-software-local/#{name}/#{name}-#{version}.linux-arm64.tar.gz"
...
source url: "https://artifactory-internal.ps.chef.co/ui/repos/tree/General/omnibus-software-local/#{name}/#{name}-#{version}.linux-amd64.tar.gz"
